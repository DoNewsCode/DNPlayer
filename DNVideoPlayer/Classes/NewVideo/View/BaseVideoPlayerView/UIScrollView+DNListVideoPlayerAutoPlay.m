...
#pragma mark - UIScrollViewDelegate_ListViewAutoplaySJAdd
...
#pragma mark - _SJScrollViewDelegateObserver
...
- (void)setSj_autoplayConfig:(nullable DNPlayerAutoPlayManagerConfig *)sj_autoplayConfig {
    objc_setAssociatedObject(self, @selector(sj_autoplayConfig), sj_autoplayConfig, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (nullable DNPlayerAutoPlayManagerConfig *)sj_autoplayConfig {
    return objc_getAssociatedObject(self, _cmd);
}
...
static void sj_tableViewConsiderPlayNewAsset(UITableView *tableView) {
    ...
    DNPlayerAutoPlayManagerConfig *config = [tableView sj_autoplayConfig];
