...
+ (UIColor *)ca_colorWithHexString:(NSString *)hexString alpha:(CGFloat)alpha
{
    return [[self ca_colorWithHexString:hexString] colorWithAlphaComponent:alpha];
}

+ (UIImage*)ca_createImageWithColor:(UIColor*) color
{
